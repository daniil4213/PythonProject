...
def snake(headname, bodyname, snakeHead, snakeList, lead_x, lead_y):
...
while not gameExit:
    ...
    for eachSegment in snakeList[:-1]:
        if eachSegment == snakeHead:
            gameDisplay.blit(pygame.image.load('fon.jpg'), (0,0))
    ...
    # отображение змейки
    snake('snake.png', 'body.png', snakeHead, snakeList, lead_x, lead_y)
    pygame.display.update()
